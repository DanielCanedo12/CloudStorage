 ...
 * ATENÇÃO
 * 
 * Este plugin foi editado: O slider utilizado por este pugin (o nativo do browser) foi trocado pelo seiyria-bootstrap-slider
 *************************/
...
(function (root, factory) {
    ...
    function _setZoomerVal(v) {
        if (this.options.enableZoom) {
            ...
            //$(this.elements.zoomer).bootstrapSlider('setValue', parseFloat(fix(v, 4)));
            this.elements.slider.setValue(parseFloat(fix(v, 4)));
        }
    }
    ...
    function _initializeZoom() {
        ...
        function change() {
            _onZoom.call(self, {
                value: parseFloat( self.elements.slider.getValue() ),
        ...
        $(zoomer).change(change).attr('type', 'text').addClass('slider slider-horizontal');

        self.elements.slider = new Slider(zoomer, {
            value: 1,
            step: 0.01
        });
    ...
    function _updatePropertiesFromImage() {
        ...
        if (self.options.enableZoom) {
            ...
            this.elements.slider.options.min = parseFloat(fix(minZoom, 4));
            this.elements.slider.options.max = parseFloat(fix(maxZoom, 4));

            initialZoom = Math.max((boundaryData.width / imgData.width), (boundaryData.height / imgData.height));
            _setZoomerVal.call(self, initialZoom);

            this.elements.slider.refresh();
